...
export default function SaveProfessorButton({ isSaved, pending = false, savedNote, error, onToggle, compact = false }: SaveProfessorButtonProps) {
  ...
  return (
    <button
      ...
      aria-label={isSaved ? "Saved professor" : "Save professor"}
      title={error || (isSaved && savedNote ? savedNote : isSaved ? "Saved professor" : "Save professor")}
    >
