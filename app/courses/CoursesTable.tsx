          ...
          <ul className="divide-y divide-zinc-100 dark:divide-white/[0.04]">
            ...
            {courses.length === 0 && (
              <li className="px-6 py-16 text-center">
                ...
                <button onClick={clearAll} className="mt-3 text-sm text-emerald-600 hover:text-emerald-500 dark:text-emerald-500 dark:hover:text-emerald-400 transition-colors font-medium">Clear all filters →</button>
              </li>
            )}
          </ul>
        </div>
